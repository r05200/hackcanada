...
export default function Register() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setLoading(true)
    try {
      await register(name.trim(), email.trim(), password, ridingId || undefined)
    } catch (err: any) {
        ...
        >
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2.5 bg-dark-600 border border-dark-500 rounded-lg text-gray-100 outline-none focus:border-accent focus:ring-2 focus:ring-accent/30 transition"
            >
